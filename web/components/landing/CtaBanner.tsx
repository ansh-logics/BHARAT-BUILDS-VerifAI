...
export function CtaBanner() {
  return (
    <section className="py-20 md:py-28 bg-muted/20 border-t border-border/40 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 size-[500px] rounded-full bg-primary/10 blur-[120px]" />
